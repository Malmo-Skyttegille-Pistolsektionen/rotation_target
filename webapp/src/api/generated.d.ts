...
export interface paths {
    ...
    "/audios/{id}/delete": {
         ...
         * @description Shipped clips are read-only and answer `404`, the same as a clip that does not exist.
         */
...
export interface operations {
    ...
    deleteAudio: {
        ...
        responses: {
            ...
            /** @description The clip is playing (`Audio is currently playing`). LittleFS has no unlink-while-open, so removing it would corrupt the read. */
            409: {
                headers: {
                    [name: string]: unknown;
                };
